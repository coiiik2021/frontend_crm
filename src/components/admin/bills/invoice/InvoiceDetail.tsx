...
export default function InvoiceDetail() {
    ...
    const [productsTotal, setProductsTotal] = useState<{ priceProduct: number }>({ priceProduct: 0 });
    const [selectService, setSelectService] = useState<SelectedService | null>(null);
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const dataRequestAPI = await axios.get("http://localhost:8080/api/invoice/" + id);
