...
const GetPriceNetViettel = async () => {
    const API = "/EXPORT%20-%20pkg%20Saver!A9:K52?key=AIzaSyCG2DZqV_CDvtKqDkn4acepQiWq7otowKI";
...
export { GetPriceNetViettel, GetPriceNetDHLVN, GetPriceNetFedEx, GetPriceNetSF,GetPriceNetDHLSin, GetPriceNetSeaTrucking,  GetPriceNetSeaNoTrucking, GetPriceNetTMDT, GetCodeByCompany ,GetTrackingOrder};